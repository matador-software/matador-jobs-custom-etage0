<?php
/**
 * Plugin Name: Matador Jobs Custom Extension for Etage0
 * Plugin URI: https://matadorjobs.com/
 * Description: Extends Matador Jobs for custom features as requested by Etage0
 * Author: Matador Software, LLC, Jeremy Scott (jeremyescott)
 * Author URI: http://matadorjobs.com
 * Version: 1.0.0
 * Text Domain: matador-extension-custom-etage0
 * Domain Path: /languages
 *
 * Extends Matador Jobs for custom features as requested by Etage0
 *
 * Matador Jobs Custom Extension for Etage0 is free software: you can
 * redistribute it and/or modify it under the terms of the GNU General Public
 * License as published by the Free Software Foundation, either version 3 of
 * the License, or any later version.
 *
 * Matador Jobs Custom Extension for Etage0 is distributed in the hope that it will be useful,
...
function admin_notice_php() {
	...
	$plugin = __( 'Matador Jobs Custom Extension for Etage0', 'matador-extension-custom-etage0' );
